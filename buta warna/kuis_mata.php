            ...
            <form action="jawaban_benar_kuis_mata.php" method="post">
                <div class="row">
                    <div class="col-4">
                        ...
                        <input type="text" name="jawaban1" class="mt-4" placeholder="Jawaban">
                    </div>

                    <div class="col-4">
                        <img src="aset/3.jpg" alt="" height="250px" width="250px">
                        <input type="text" name="jawaban2" class="mt-4" placeholder="Jawaban">
                    </div>

                    <div class="col-4">
                        <img src="aset/4.jpg" alt="" height="250px" width="250px">
                        <input type="text" name="jawaban3" class="mt-4" placeholder="Jawaban">
                    </div>
                </div>
                ...
                <div class="row mt-5">
                    <div class="col-4">
                        ...
                        <input type="text" name="jawaban4" class="mt-4" placeholder="Jawaban">
                    </div>

                    <div class="col-4">
                        <img src="aset/6.jpg" alt="" height="250px" width="250px">
                        <input type="text" name="jawaban5" class="mt-4" placeholder="Jawaban">
                    </div>

                    <div class="col-4">
                        <img src="aset/7.jpg" alt="" height="250px" width="250px">
                        <input type="text" name="jawaban6" class="mt-4" placeholder="Jawaban">
                    </div>
                </div>
                ...
                <div class="row mt-5">
                    <div class="col-4">
                        ...
                        <input type="text" name="jawaban7" class="mt-4" placeholder="Jawaban">
                    </div>

                    <div class="col-4">
                        <img src="aset/9.jpg" alt="" height="250px" width="250px">
                        <input type="text" name="jawaban8" class="mt-4" placeholder="Jawaban">
                    </div>

                    <div class="col-4">
                        <img src="aset/10.jpg" alt="" height="250px" width="250px">
                        <input type="text" name="jawaban9" class="mt-4" placeholder="Jawaban">
                    </div>
                </div>
                ...
                <div class="row mt-5 mb-5">
                    <div class="col-4">
                        ...
                        <input type="text" name="jawaban10" class="mt-4" placeholder="Jawaban">
                    </div>

                    <div class="col-4">
                        <img src="aset/12.jpg" alt="" height="250px" width="250px">
                        <input type="text" name="jawaban11" class="mt-4" placeholder="Jawaban">
                    </div>

                    <div class="col-4">
                        <img src="aset/13.jpg" alt="" height="250px" width="250px">
                        <input type="text" name="jawaban12" class="mt-4" placeholder="Jawaban">
                    </div> 
                </div>
        
                <input type="submit" value="Submit" class="btn btn-primary mt-4" style="width:20%;">
            </form>
        </div>
    </div>
